...
#define PATH_PIPED_NAME_SERVER_TO_MINER "/usr/src/mnt/mta/Piped_Server_To_Miner_"
#define PATH_OF_COMMON_FILE "/usr/src/mnt/mta/mtacoin.conf"
#define PATH_PIPED_NAME_MINER_TO_SERVER "/usr/src/mnt/mta/Piped_Miner_To_Server"
